<template>
	...
	<h3>发表评论</h3>
	<hr>
	<textarea placeholder="请输入评论内容（最多评论120字）" maxlength="120"
	...
	<div class="cmt-list">
		...
		<div class="cmt-title">
		    第{{ i+1 }}楼&nbsp;&nbsp;用户：{{ item.user_name }}&nbsp;&nbsp;发表时间：{{ item.add_time | dateFormant('YYYY-MM-DD HH:mm:ss') }}
		</div>
		<div class="cmt-body">
